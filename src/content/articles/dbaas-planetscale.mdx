...
published: true
v0:
  - https://r2-image.raunaqgupta.workers.dev/dbaas-planetscale/v0/login.view.png?f=avif
  - https://r2-image.raunaqgupta.workers.dev/dbaas-planetscale/v0/eula.view.png?f=avif
  - https://r2-image.raunaqgupta.workers.dev/dbaas-planetscale/v0/company.create.png?f=avif
  - https://r2-image.raunaqgupta.workers.dev/dbaas-planetscale/v0/user.add.png?f=avif
  - https://r2-image.raunaqgupta.workers.dev/dbaas-planetscale/v0/cluster.view.png?f=avif
  - https://r2-image.raunaqgupta.workers.dev/dbaas-planetscale/v0/keyspace.view.png?f=avif
improvingDashboards:
...
byod:
  - https://r2-image.raunaqgupta.workers.dev/dbaas-planetscale/byod-1.png?f=avif
  - https://r2-image.raunaqgupta.workers.dev/dbaas-planetscale/byod-2.png?f=avif
---
...
<Gallery collection={frontmatter.byod}/>
...
<PageLink direction="next" label="Case study: Revamping the login workflow to showcase the free tier" url="/portfolio/login-concept-planetscale" />
...
<FlexColumn>
  <PageLink direction="prev" label="Case study: Secure Application on Cisco Observability Platform" url="/portfolio/appsec" />
  <PageLink direction="next" label="Case study: Revamping the login workflow to showcase the free tier" url="/portfolio/login-concept-planetscale" />
</FlexColumn>
